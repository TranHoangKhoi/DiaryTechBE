...
import { getFarmer, getFarmerById, getOwnerStatistics, registerOwner, softDeleteFarmer, hardDeleteFarmer, restoreFarmer } from '../controllers/owner.controller';
...
router.patch('/farmer/:id/soft-delete', auth, checkRole(roleUser.owner), requireAnyModuleAccess(MODULE_KEY_VALUES), softDeleteFarmer);
router.delete('/farmer/:id/hard-delete', auth, checkRole(roleUser.owner), requireAnyModuleAccess(MODULE_KEY_VALUES), hardDeleteFarmer);
router.patch('/farmer/:id/restore', auth, checkRole(roleUser.owner), requireAnyModuleAccess(MODULE_KEY_VALUES), restoreFarmer);
